...
(If you don't know how to use animation controllers to execute commands, you can read a tutorial on how to do so [here](https://wiki.bedrock.dev/docs/tutorials/entity_commands.html))
```json
